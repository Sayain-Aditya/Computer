...
const Category = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editId) {
        await axios.put(`https://computer-shop-backend-five.vercel.app/api/categories/update/${editId}`, formData)
        toast.success('Category updated successfully!')
      } else {
        await axios.post('https://computer-shop-backend-five.vercel.app/api/categories/create', formData)
  ...
  const handleDelete = async (id) => {
    ...
    try {
      setError('')
      await axios.delete(`https://computer-shop-backend-five.vercel.app/api/categories/delete/${id}`)
