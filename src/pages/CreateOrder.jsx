    ...
    try {
      ...
      for (const item of selectedProducts) {
        try {
          ...
          try {
            const stockResponse = await axios.put(`http://localhost:5000/api/products/update-stock/${item._id}`, {
            ...
            const stockResponse = await axios.put(`http://localhost:5000/api/products/update/${item._id}`, {
                  ...
                  <div className="flex flex-col sm:flex-row gap-3">
                    ...
                    <motion.button
                      onClick={async () => {
                        ...
                        try {
                          await axios.post('http://localhost:5000/api/orders/create', quotationData)
